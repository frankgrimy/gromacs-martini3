...
RESCALDIR=$REPOROOT/comparison/workdir/rescaled
...
/usr/bin/mkdir -p $RESCALDIR

# Unzip the protein structure
printf "\n${GREEN}Unzipping the protein structure...${CLEAR}\n"
/usr/bin/unzip $REPOROOT/comparison/src/fold_foxp1_solo_qrich_2025_01_07_11_21.zip "${STRNAME}.cif" -d $RESCALDIR
printf "${GREEN}Unzipping the protein structure...OK${CLEAR}\n\n"

# Unzip the rescaled Martini 3 force field
printf "\n${GREEN}Unzipping the rescaled Martini 3 force field...${CLEAR}\n"
/usr/bin/unzip $REPOROOT/comparison/src/martini_v300_pws.zip -d $RESCALDIR
FF=$RESCALDIR/martini_v300_pws
printf "${GREEN}Unzipping the rescaled Martini 3 force field...OK${CLEAR}\n\n"
...
printf "${CYAN}#include \"$FF/martini_v3.0.0.itp\"\n"
printf "#include \"$FF/martini_v3.0.0_solvents_v1.itp\"\n"
printf "#include \"$FF/martini_v3.0.0_ions_v1.itp\"\n"
